var printTasks, fatalError, missingTask, sakefileDirectory, fs = require("fs"), path = require("path"), helpers = require("./helpers"), optparse = require("./optparse"), Six = require("./six"), existsSync = fs.existsSync || path.existsSync, tasks = {}, options = {}, switches = [], oparse = null;
...
exports.run = function() {
  ...
  Six.run(fs.readFileSync("Sakefile").toString(), {
    filename: "Sakefile"
  });
...
sakefileDirectory = function(dir) {
