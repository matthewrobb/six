var Tree = require("./esom/tree").Tree, filters = require("./filters").filters, uglify = require("uglify-js"), jsp = uglify.parser, pro = uglify.uglify;
...
function rewrite(src) {
  ...
  program.select(".CallExpression > callee[name='super']").forEach(function(node) {
    ...
    Call.node.compile = function() {
      return "this.constructor.__super__.constructor.call(this" + (args.node ? "," + args : "") + ")";
    };
  });
